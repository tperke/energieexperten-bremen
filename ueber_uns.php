...
$breadcrumbs = [['name' => 'Startseite', 'url' => site_url()], ['name' => 'Über uns', 'url' => site_url('ueber-uns/')]];
site_header('ueber_uns', ['breadcrumbs' => $breadcrumbs]);
render_breadcrumbs($breadcrumbs);
?>
<main id="main-content">
    <section class="page-hero"><div class="wrap narrow"><p class="eyebrow">Orientierung und Beratung</p><h1>Über Energieexperten Bremen</h1><p class="lead">Energieexperten Bremen ist ein regional ausgerichtetes Energieberatungsunternehmen für Bremen mit Büro in Düsseldorf. Wir erklären Fachthemen verständlich, unterstützen bei der Auswahl geeigneter Leistungen und benennen transparent, wenn externe Fachpartner beteiligt werden.</p></div></section>
    <section class="section"><div class="wrap content-layout"><article class="article-content">
        <section class="content-section"><h2>Was wir leisten</h2><p>Eigentümer, Vermieter, Wohnungseigentümergemeinschaften und Unternehmen erhalten eine verständliche Einordnung zu Energieberatung, Sanierungsfahrplan, Energieausweis, Förderung und Baubegleitung. Inhalte werden mit Prüfdatum und vorrangig amtlichen Quellen veröffentlicht.</p><p>Das Verzeichnis soll nachweisbare Leistungen realer Anbieter sichtbar machen. Profile erscheinen erst nach einer dokumentierten Prüfung zentraler Angaben und einer Bestätigung für die Veröffentlichung.</p></section>
        <section class="content-section"><h2>Was unsere Inhalte leisten</h2><p>Unsere redaktionellen Informationen bieten eine erste Orientierung. Sie ersetzen keine Beratung für ein konkretes Gebäude, keine Rechtsberatung und keine Förderzusage. Vor einer individuellen Leistung klären wir Umfang, Qualifikation und verantwortliche Fachperson transparent.</p><p>Wir behaupten weder eine vollständige Marktübersicht noch eine automatische Neutralität jeder Platzierung. Umfang des Verzeichnisses, Prüfmaßstab und wirtschaftliche Beziehungen werden offen beschrieben.</p></section>
        <section class="content-section"><h2>Regionale Verantwortung</h2><p>Bremer Gebäude unterscheiden sich nach Bauzeit, Konstruktion, Nutzung und Wärmeversorgung. Unser Angebot verbindet deshalb bundesweite Anforderungen mit offiziellen Informationen des Landes Bremen und örtlichen Beratungsangeboten.</p><p>Stadtteilseiten werden erst veröffentlicht, wenn eigenständige, nachprüfbare Inhalte vorliegen. Automatisch erzeugte Seiten, die lediglich Ortsnamen austauschen, sind ausgeschlossen.</p></section>
